                      ...
                      while($row = mysqli_fetch_array($result)){
                        echo '
                          <tr>
                              ...
                              <td>'.$row['produit'].'</td>
                              <td>'.$row['periode'].'</td>
                              <td> <a href="modification.php?id='.$row['id'].'" class="btn text-white  mb-2" style="background-color:#31C44E;">Modifier</a></td>
                              <td> <a href="supp.php?id='.$row['id'].'" class="btn text-white  mb-2" style="background-color: #EDBA35;">Supprimer</a></td>
...
<script>
  $(document).ready(function(){  
      ...
      var dataTable = $('#tableActeur').DataTable({
  "processing":true,
  "serverSide":true,
  "scrollX": true,
   "scrollY": true,
